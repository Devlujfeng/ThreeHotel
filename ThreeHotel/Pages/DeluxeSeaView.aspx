<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeluxeSeaView.aspx.cs" Inherits="ThreeHotel.Pages.DeluxeSeaView" %>
    ...
    <table class="auto-style3">
        ...
        <tr>
            <td colspan="3"><span style="color: rgb(134, 109, 45)"><h1 class="auto-style18">
                <asp:Label ID="Label1" runat="server" Text="DELUXE SEA VIEW ROOM" ForeColor="#BB9754"></asp:Label>
                </h1></span></td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td colspan="3">
                <h2 style="font-family: SortsMillGoudyRegular; color: rgb(52, 52, 52); font-size: 28px; font-weight: normal; line-height: 33px; margin: 0px; padding: 0px; letter-spacing: 1px; clear: both; font-style: normal; font-variant: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgba(255, 255, 255, 0.952941);">
                    Savour panoramic views of the ocean</h2>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                     ...
                     <tr>
                         <td>
                             ...
                             <table class="auto-style3">
                                 <tr>
                                     <td colspan="2">
                                         <asp:Label ID="Label6" runat="server" Text="Be pampered by the extra space and exquisite comfort of our Deluxe Sea View Rooms, which combines both modern and traditional Chinese designs." Width="466px" style="text-align: justify"></asp:Label>
                                         <br />
                                         <asp:Label ID="Label4" runat="server" Text="The West Coast Park is visible through large windows. Its view is remarkably likened to a landscape painting." Width="466px"></asp:Label>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td colspan="2">
