<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HorizonCityView.aspx.cs" Inherits="ThreeHotel.Pages.HorizonCityView" %>
    ...
    <table class="auto-style3">
        ...
        <tr>
            <td colspan="3"><span style="color: rgb(134, 109, 45)"><h1 class="auto-style18">
                <asp:Label ID="Label1" runat="server" Text=" HORIZON CITY VIEW ROOM" ForeColor="#BB9754"></asp:Label>
                </h1></span></td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td colspan="3">
                <h2 style="font-family: SortsMillGoudyRegular; color: rgb(52, 52, 52); font-size: 28px; font-weight: normal; line-height: 33px; margin: 0px; padding: 0px; letter-spacing: 1px; clear: both; font-style: normal; font-variant: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgba(255, 255, 255, 0.952941);">
                    Comfortable interiors for a relaxing stay</h2>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                     ...
                     <tr>
                         <td>
                             ...
                             <table class="auto-style3">
                                 <tr>
                                     <td colspan="2">
                                         <asp:Label ID="Label6" runat="server" Text="Horizon City View Rooms embrace you with comfort and privacy, offering a full array of amenities that will make your stay productive and peaceful." Width="466px"></asp:Label>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td colspan="2">
