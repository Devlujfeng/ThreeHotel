<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeluxeCityView.aspx.cs" Inherits="ThreeHotel.Pages.DeluxeCityView" %>
    ...
    <table class="auto-style3">
        ...
        <tr>
            <td colspan="3"><span style="color: rgb(134, 109, 45)"><h1 class="auto-style18">
                <asp:Label ID="Label1" runat="server" Text="DELUXE CITY VIEW ROOM" ForeColor="#BB9754"></asp:Label>
                </h1></span></td>
        </tr>
        <tr>
            <td colspan="3">
                <asp:Image ID="Image12" runat="server" ImageUrl="~/Images (ThreeHotel)/BoldLine1.PNG" Width="746px" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td colspan="3">
                <h2 style="font-family: SortsMillGoudyRegular; color: rgb(52, 52, 52); font-size: 28px; font-weight: normal; line-height: 33px; margin: 0px; padding: 0px; letter-spacing: 1px; clear: both; font-style: normal; font-variant: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgba(255, 255, 255, 0.952941);">
                    Modern elegance with dramatic views</h2>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <asp:Image ID="Image10" runat="server" ImageUrl="~/Images (ThreeHotel)/BoldLine2.PNG" Width="736px" />
            </td>
        </tr>
         <tr>
             <td>
                     ...
                     <tr>
                         <td>
                             ...
                             <table class="auto-style3">
                                 <tr>
                                     <td colspan="2">
                                         <asp:Label ID="Label6" runat="server" Text="Deluxe City View Rooms take luxury to a new level by combining both modern and traditional Chinese designs." Width="466px" style="text-align: justify"></asp:Label>
                                        <br />
                                     </td>
                                 </tr>
                                 <tr>
                                     <td colspan="2">
                                         ...
                                         <p>
                                             ...
                                             &nbsp;Magnificent views of the Singapore cityscape</p>
                                         <p>
                                         ...
                                         <p>
                                             ...
                                             &nbsp;Each room offers 36 sqm / 388 sqf</p>
                                         <br />
